    ...
    static public function set($jenis_pengeluaran){
        ...
        return Datatables::of($jenis_pengeluaran)
            ->addColumn('action', function ($jenis_pengeluaran) {
                ...
                return
                    '<div class="btn-group">' .
                    '<a href="' . route('jenis_pengeluaran.edit', $jenis_pengeluaran->id) . '" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" style="margin-right: 5px" >Edit</a>' .
