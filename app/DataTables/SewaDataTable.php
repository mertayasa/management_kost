        ...
        return Datatables::of($sewa)
            ...
            ->addColumn('action', function ($sewa) {
                ...
                return
                    ...
                    '<a href="' . route('sewa.edit', $sewa->id) . '" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" style="margin-right: 5px" ><i class="fas fa-sign-out-alt"></i></a>' .
